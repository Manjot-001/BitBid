          ...
          <nav className="navbar navbar-expand-lg navbar-dark bg-white py-3 px-4">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              <div className="navbar-nav ms-auto py-0">
                ...
                <Link to={'/admin/viewbid'} className="nav-item nav-link">
                  View Bid
                </Link>

                <Link to={'/admin/managequery'} className="nav-item nav-link">
                  Manage Query
                </Link>
                <div className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu m-0">
                    <Link to={'/admin/addtechnology'} className="dropdown-item">
                     Add
                    </Link>
                    <Link to={'/admin/managetechnology'} className="dropdown-item">
                      Manage
                    </Link>
                  </div>
                </div>
