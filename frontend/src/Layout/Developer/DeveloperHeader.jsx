          ...
          <nav className="navbar navbar-expand-lg navbar-dark bg-white py-3 px-4">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              <div className="navbar-nav ms-auto py-0">
                <Link to="/developer" className="nav-item nav-link active">
                  Dashboard              
                  </Link>
                <Link to={'/developer/developerpost'} className="nav-item nav-link">
                  Post
                </Link>
                <Link to={'/developer/trackbidstatus'} className="nav-item nav-link">
                  Track Bid Status
                </Link>
